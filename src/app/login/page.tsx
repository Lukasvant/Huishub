...
import { HiveIllustration } from "@/components/hive-illustration";
...
export default function LoginPage() {
  ...
  return (
    <main className="mx-auto flex min-h-screen max-w-5xl items-center px-5 py-8">
      <div className="grid w-full items-center gap-8 md:grid-cols-[minmax(0,1fr)_24rem]">
        <div className="order-2 w-full max-w-md justify-self-center md:order-1">
          ...
          <Card className="p-5 sm:p-6">
            ...
            <form className="mt-5 space-y-4" onSubmit={submit}>
              ...
              {!configured && (
                <Message tone="info">
                  Configureer Firebase in <code>.env.local</code> om in te
                  loggen.
                </Message>
              )}
              <Button
        ...
        <section className="order-1 md:order-2">
          <HiveIllustration className="mx-auto max-w-[18rem] md:max-w-none" />
          <div className="mx-auto mt-4 max-w-xs text-center md:text-left">
            <p className="eyebrow">Rustig geregeld</p>
            <p className="mt-2 font-serif text-3xl italic leading-tight">
              Een rustig nest voor alles wat thuis rondzoemt.
            </p>
          </div>
        </section>
      </div>
